...
function appendCat(){const newCats = [...cats, "Broom"];return newCats}

function prependCat(){const newCats = ["Arnold", ...cats];return newCats}

function removeLastCat(){const newCats = cats.slice(0, -1)
    return newCats
}
